...
final class UsuarioModel extends Model {
    ...
    public function checkLogin(){
        ...
        $permissoes = [
            ...
            "Estagiario" => ["pgInicial.php", "empresas.php", "supervisores.php", "representantes.php", "professores.php", "documentos.php", "documento.php", "salvarDocumento.php", "excluirDocumento.php"]
        ];
