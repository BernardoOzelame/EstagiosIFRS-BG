...
<head>
    ...
    <title>Formulário da cidade</title>
...
<body>
    ...
    <a class="inserir" href="cidades.php">Voltar para a listagem</a>

    <form action="salvarCidade.php" method="POST" id="formulario">
        ...
        <input type="text" name="nome" id="nome" placeholder="Nome da cidade" value="<?php echo $cidade->getNome(); ?>">

        <label for="uf" title="Este campo é obrigatório!">UF<span class="obrigatorio"> *</span></label>
        <input type="text" maxlength="2" name="uf" id="uf" placeholder="UF da cidade" value="<?php echo $cidade->getUf(); ?>">
