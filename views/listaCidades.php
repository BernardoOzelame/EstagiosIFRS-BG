...
<body>
    ...
    <div><a class="inserir" href="cidade.php">inserir nova cidade</a></div>
            ...
            <tbody>
                <?php
                    foreach($cidades as $cidade) {
                        ...
                        echo "<td>";
                            echo "<a class='acoes editar' href='cidade.php?id=" . $cidade->getId() . "'><i class='fa-solid fa-pen-to-square'></i></a>";
                            echo "<a class='acoes excluir' href='#' data-id='" . $cidade->getId() . "'><i class='fa-solid fa-trash-can'></i></a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            $(".excluir").on("click", function (e) {
                ...
                confirmarExclusao(idCidade);
            });

            function confirmarExclusao(idCidade) {
                Swal.fire({
                    title: 'Tem certeza?',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'excluirCidade.php?id=' + idCidade;
                    }
                });
            }
        });
